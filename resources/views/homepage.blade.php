...
<div class="mojmeni ">
	<i class="fa fa-angle-right fa-3x align-middle"></i>
					...
					<div class="container-fluid">
							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="navbar-nav mx-lg-auto ml-auto">
									...
									<li class="nav-item">
										<a class="nav-link" href="about-me.html">O meni</a>
									</li>
					...
					<div class="col-lg-4 col-md-6 course-grid" data-aos="fade-right" data-aos-offset="200"
						...
						<div class="course-grid-inf box-shadow">
							...
							<div class="course-content">
								...
								<a href="course.html"><button class="price-course btn font-weight-bold w-100">SAZNAJ VIŠE</button></a>
