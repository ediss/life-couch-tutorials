			...
			<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
				...
				<tr>
					<td valign="middle" class="hero bg_white"
						style="background-image: url(../assets/images/banners/main-banner2.jpg); background-size: cover; height: 550px;">
							...
							<tr>
								<td>
									<div class="text" style="padding: 0 3em; text-align: center;">
										<h2>ZDRAVO {{ $name }}!</h2>
										<p>Hvala na prijavi za radionicu <a
										...
										<p>Uskoro ćete dobiti mail sa instrukcijama kako da se u zakazano vreme uključite na radionicu.</p>
									</div>
								</td>
							</tr>
						</table>
