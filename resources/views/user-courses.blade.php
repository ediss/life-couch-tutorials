                ...
                <div class="welcome-grids row">
                    ...
                    <div class="col-lg-4 col-md-6 course-grid" data-aos="fade-right" data-aos-offset="200"
                        ...
                        <div class="course-grid-inf box-shadow">
                            ...
                            <a href="{{route('single-course', $course->courses->slug)}}#course-content" class="popup-with-zoom-anim play-view text-center position-absolute" href="{{route('single-course', $course->courses->slug)}}#course-content">
                                <span class="video-play-icon">
                                    <span class="fa fa-play"></span>
                                </span>
                            </a>
                            <a href="{{route('single-course', $course->courses->slug)}}#course-content">
                            ...
                            <div class="course-content">
                                <div class="course-info">
                                    ...
                                    <a href="{{route('single-course', $course->courses->slug)}}#course-content" class="course-titlegulp-wrapper">
